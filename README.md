...
such as `v0.1.2`. You can also publish by pushing a version tag:

```sh
git tag v0.1.2
git push HyperLink v0.1.2
```
...
```text
Hyperlink-0.1.2-linux-x64.tar.gz
Hyperlink-0.1.2-macos-universal.tar.gz
Hyperlink-0.1.2-windows-x64.zip
hyperlink_0.1.2_amd64.deb
```
